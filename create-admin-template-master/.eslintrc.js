module.exports = {
  ...
  rules: {
    ...
    'vue/singleline-html-element-content-newline': 'off', // 元素之间是否强制换行
    'vue/multiline-html-element-content-newline': 'off', // 多行元素之间是否强制换行
    'vue/name-property-casing': ['error', 'PascalCase'], // 组件的name属性的首字母的大小写
    'vue/no-v-html': 'off', // 是否允许通过v-html来绑定数据
